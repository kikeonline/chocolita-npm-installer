...
var fs = require('fs')
var os = require('os');
var chocoPath = 'https://github.com/monchitonet/Chocolita.git';
...
function banner() {
			log(chalk.bold.blue(EOL +
				...
				'   –------       Wordpress Tema Base - NPM Installer 1.0' + EOL + 
				'      ()'));
	console.log('');
}
function bye() {
...
function gitClone(themeName, hostName) {
	  git.Clone(chocoPath, themeName)
	   ...
	   .catch(function(err) {
	   		console.error(chalk.red(chalk.bold.red('! ') + err)); 
	   		bye();
	  });
}
